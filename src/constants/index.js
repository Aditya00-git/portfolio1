export const projects = [
  {
    id: "01",
    name: "JARVIS",
    full: "JARVIS – Offline AI Assistant",
  ...
  },
  {
    id: "05",
    name: "FAKENEWS",
    full: "Fake Education News Detector",
...
export const achievements = [
  { icon: "◈", title: "Reliance Foundation Scholar", sub: "Undergraduate Scholarship" },
...
export const certifications = [
  { name: "Oracle Gen AI", issuer: "Oracle", year: "2025" },
  { name: "Oracle Data Science", issuer: "Oracle", year: "2025" },
  { name: "Oracle AI Foundations", issuer: "Oracle", year: "2025" },
  { name: "NPTEL Cloud Computing", issuer: "NPTEL", year: "2025" },
  { name: "Google Bits & Bytes of Networking", issuer: "Coursera / Google", year: "2025" },
  { name: "AI Fundamentals Badge", issuer: "IBM", year: "2026" },
];

export const skills = [
  "React", "Node.js", "Python", "PHP",
  "MySQL", "MongoDB", "JavaScript", "HTML / CSS",
  "Machine Learning", "Git", "REST APIs", "CLI Tools",
];
...
export const marqueeTech = [
  "React", "Node.js", "Python", "PHP", "MySQL",
  "MongoDB", "JavaScript", "Machine Learning", "REST APIs",
  "Git", "Streamlit", "Ollama", "PyQt", "HTML / CSS",
];